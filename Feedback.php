...
<section id="homepage" align="center">
    ...
    <div id="ReviewOptions" align="center">
        <div>
            <h5>Review</h5>
        ...
        <div>
            ...
            <form>
                <h4>User: Lorem Ipsum</h4>

                <textarea placeholder="Type here"></textarea><br><br>
                Your rating:<input type="number" value='5' min='1' max='5'><br><br>
                <input type="submit" id="Submit" class="button small" value="Make review">
