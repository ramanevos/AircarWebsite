...
<div id="header">
    <div class="navigation" id="mynavigation">
        ...
        <a href="Index.php" class="active"><!--logged in homepage-->Home</a>

        <a href="Login.php"><!--logged out home page address-->Login</a>
...
<section id="homepage" align="center">
    ...
    <div id="welcome" align="center">
        ...
        <div id="WelcomeOptions">
            ...
            <p><a href="about.html" class="button fit">SEARCH A CAR</a></p>
        </div>
        <div id="WelcomeOptions">


            <h4>DO YOU HAVE A CAR TO LIST?</h4>
            <hr>

            <a href="about.html" class="button fit">RENT YOUR CAR</a>
        </div>
    </div>
