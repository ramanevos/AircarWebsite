...
<!-- include php for login details as this page will only be accessed when logged in-->
...
<section id="homepage" align="center">
    ...
    <div id="find-a-car" align="center">
        ...
        <div id="car-image" style="float: left; width: 50%;">
            <p><img src="images/bmw.jpeg" alt="bmw"></p>
        </div>
        <div id="car-details" style="float: right; width: 40%">
            <p style="margin: 0;" align="left">Registration: </p>
            <p style="margin: 0;" align="left">Description: </p>
            <p style="margin: 0;" align="left">Area Code: </p>
            <p style="margin: 0;" align="left">Available: </p>
            <p style="margin: 0;" align="left">From: </p>
            <p style="margin: 0;" align="left">To: </p>
            <p style="margin: 0;" align="left">Accepted Payment Types: </p>
            <p style="margin: 0;" align="left">Insurance: </p>
            <p style="margin: 0;" align="left">Price: </p>
            <p><a href="payment.php" class="button fit">Rent Car</a></p>
        </div>
    </div>
